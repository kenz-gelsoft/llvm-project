//===-- NativeRegisterContextHaiku_x86_64.h ---------------------*- C++ -*-===//
//
...
#ifndef lldb_NativeRegisterContextHaiku_x86_64_h
#define lldb_NativeRegisterContextHaiku_x86_64_h
...
class NativeRegisterContextHaiku_x86_64
    : public NativeRegisterContextHaiku,
      public NativeRegisterContextWatchpoint_x86 {
public:
  NativeRegisterContextHaiku_x86_64(const ArchSpec &target_arch,
  ...
  llvm::Error
  CopyHardwareWatchpointsFrom(NativeRegisterContextHaiku &source) override;
...
#endif // #ifndef lldb_NativeRegisterContextHaiku_x86_64_h
