//===-- RegisterContextHaiku_i386.cpp --------------------------*- C++ -*-===//
//
...
RegisterContextHaiku_i386::RegisterContextHaiku_i386(
    const ArchSpec &target_arch)
    : RegisterInfoInterface(target_arch) {}

size_t RegisterContextHaiku_i386::GetGPRSize() const { return sizeof(GPR); }

const RegisterInfo *RegisterContextHaiku_i386::GetRegisterInfo() const {
...
uint32_t RegisterContextHaiku_i386::GetRegisterCount() const {
