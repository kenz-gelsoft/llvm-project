...
void HaikuSignals::Reset() {
  ...
  AddSignal(5,      "SIGCHLD",      false,    false,  true,   "child status has changed", "SIGCLD");
  AddSignal(6,      "SIGABRT",      false,    true,   true,   "abort()/IOT trap", "SIGIOT");
  AddSignal(7,      "SIGPIPE",      false,    true,   true,   "write to pipe with reading end closed");
  AddSignal(8,      "SIGFPE",       false,    true,   true,   "floating point exception");
  AddSignal(9,      "SIGKILL",      false,    true,   true,   "kill");
  AddSignal(10,     "SIGSTOP",      true,     true,   true,   "process stop");
  AddSignal(11,     "SIGSEGV",      false,    true,   true,   "segmentation violation");
  AddSignal(12,     "SIGCONT",      false,    false,  true,   "process continue");
  AddSignal(13,     "SIGTSTP",      false,    true,   true,   "tty stop");
  AddSignal(14,     "SIGALRM",      false,    false,  false,  "alarm");
  AddSignal(15,     "SIGTERM",      false,    true,   true,   "termination requested");
  AddSignal(16,     "SIGTTIN",      false,    true,   true,   "background tty read");
  AddSignal(17,     "SIGTTOU",      false,    true,   true,   "background tty write");
  AddSignal(18,     "SIGUSR1",      false,    true,   true,   "user defined signal 1");
  AddSignal(19,     "SIGUSR2",      false,    true,   true,   "user defined signal 2");
  AddSignal(20,     "SIGWINCH",     false,    true,   true,   "window size changes");
  AddSignal(21,     "SIGSTKFLT",    false,    true,   true,   "stack fault");
  AddSignal(22,     "SIGTRAP",      true,     true,   true,   "trace trap (not reset when caught)");
  AddSignal(23,     "SIGIO",        false,    true,   true,   "input/output ready/Pollable event", "SIGPOLL");
  AddSignal(24,     "SIGPROF",      false,    false,  false,  "profiling time alarm");
  AddSignal(35,     "SIGSYS",       false,    true,   true,   "invalid system call");
  AddSignal(26,     "SIGURG",       false,    true,   true,   "urgent data on socket");
  AddSignal(27,     "SIGVTALRM",    false,    true,   true,   "virtual time alarm");
  AddSignal(28,     "SIGXCPU",      false,    true,   true,   "CPU resource exceeded");
  AddSignal(29,     "SIGXFSZ",      false,    true,   true,   "file size limit exceeded");
  AddSignal(30,     "SIGBUS",       false,    true,   true,   "bus error");
  AddSignal(31,     "SIGPWR",       false,    true,   true,   "power failure");
